...
namespace TTS_server_alap_alpha_v1
{
    class LatexCommands
    {
        ...
        public static readonly string DOLLAR_TAG = "$";
        public static readonly string DOUBLE_DOLLAR_TAG = "$$";
        public static readonly string OPEN_PARANTHESIS_TAG = "\\(";
        public static readonly string CLOSE_PARANTHESIS_TAG = "\\)";
        public static readonly string BEGIN_MATH_TAG = "\\begin{math}";
        public static readonly string END_MATH_TAG = "\\end{math}";
        public static readonly string OPEN_SQUAREBRAC_TAG = "\\[";
        public static readonly string CLOSE_SQUAREBRAC_TAG = "\\]";
        public static readonly string BEGIN_EQUATION_TAG = "\\begin{equation}";
        public static readonly string END_EQUATION_TAG = "\\end{equation}";
        public static readonly string BEGIN_DISPLAY_MATH_TAG = "\\begin{displaymath}";
        public static readonly string END_DISPLAY_MATH_TAG = "\\end{displaymath}";
        public static readonly string BEGIN_EQN_ARRAY_ASTRIK_TAG = "\\begin{eqnarray*}";
        public static readonly string END_EQN_ARRAY_ASTRIK_TAG = "\\end{eqnarray*}";
        public static readonly string BEGIN_EQN_ARRAY_TAG = "\\begin{eqnarray}";
        public static readonly string END_EQN_ARRAY_TAG = "\\end{eqnarray}";
        public static readonly string BEGIN_ALIGN_ASTRIK_TAG = "\\begin{align*}";
        public static readonly string END_ALIGN_ASTRIK_TAG = "\\end{align*}";
        public static readonly string BEGIN_ALIGN_TAG = "\\begin{align}";
        public static readonly string END_ALIGN_TAG = "\\end{align}";
        #endregion
        ...
        #region ShortcutKeys
        public static readonly string DESC_CURSOR_CONT_TTS = "cursor controlled tts";
        public static readonly string DESC_DECREASE_SPEED = "decrease speed";
        public static readonly string DESC_INCREASE_SPEED = "increase speed";
        public static readonly string DESC_MATH_MODE = "math mode";
        public static readonly string DESC_PDF_ACCESSIBILITY = "pdf accessibility";
        public static readonly string DESC_TTS_OFF = "tts off";
        public static readonly string DESC_TTS_PAUSE = "tts pause";
        public static readonly string DESC_TTS_RESUME = "tts resume";
        public static readonly string DESC_TTS_START = "tts start";
        public static readonly string DESC_TTS_STOP = "tts stop";
        public static readonly string DESC_VERB_CHAR = "verbosity by character";
        public static readonly string DESC_VERB_WORD = "verbosity by word";

        public static readonly string SHRTCUT_CURSOR_CONT_TTS = "CapsLock I";
        public static readonly string SHRTCUT_DECREASE_SPEED = "CapsLock -";
        public static readonly string SHRTCUT_INCREASE_SPEED = "CapsLock +";
        public static readonly string SHRTCUT_MATH_MODE = "CapsLock D";
        public static readonly string SHRTCUT_PDF_ACCESSIBILITY = "CapsLock A";
        public static readonly string SHRTCUT_TTS_OFF = "CapsLock Q";
        public static readonly string SHRTCUT_TTS_PAUSE = "CapsLock P";
        public static readonly string SHRTCUT_TTS_RESUME = "CapsLock R";
        public static readonly string SHRTCUT_TTS_START = "CapsLock S";
        public static readonly string SHRTCUT_TTS_STOP = "CapsLock E";
        public static readonly string SHRTCUT_VERB_CHAR = "CapsLock C";
        public static readonly string SHRTCUT_VERB_WORD = "CapsLock W";
        #endregion
    }
}
